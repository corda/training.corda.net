...
Using the cash example, if "Alice creates $10" out of thin air (let us suppose she is entitled to), we would call this "minting" or "issuance." If we consumed this state and output "Bob has $10", we would call this "paying." If we had no output state, we would call this "burning" or "retiring."
