...
The next step in your prototype's lifecycle is usually to deploy it on a testnet so you can show it others. This is a step closer to production deployment and closely emulates the process. In this respect, it is a step closer to the real thing. 
