...
When it's all done, you have a running node with the basics and the finance CorDapp example. At this point, check you memory usage, and perhaps adjust down to save costs. 2 GB of RAM are perhaps enough.
