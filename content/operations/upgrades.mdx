...
Unfortunately, to test your upgrade procedures, you will have to [deploy a Testnet](https://docs.corda.net/docs/corda-os/4.5/upgrading-cordapps.html#testing-cordapp-upgrades) and perform the upgrade there.
