...
7. **Your db**. See these guides on database migration from a [development](https://medium.com/corda/cordapp-database-upgrade-migration-development-perspective-c2931e28b9b4) and [production](https://medium.com/corda/cordapp-database-upgrade-migration-production-perspective-5f655838492d) perspectives. With the associated videos [1](https://www.youtube.com/watch?v=0BKUUY4Tg20) and [2](https://www.youtube.com/watch?v=69un7I-Amwc).
