...
Preventing man-in-the-middle attacks and enabling meaningful onboarding processes can be a complex undetaking. The Corda Testnet is an alternative to addressing such concerns yourself in a pre-production setting.
