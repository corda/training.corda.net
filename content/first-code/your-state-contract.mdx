...
The training repo provides solutions and starting points for each exercise that follows. The main Corda repo also contains an empty project template to help you get started. You also have the IOU example from the previous module. And, Corda has an online IDE. You can work with the empty project template created for you there. So, there are four ways to start:

* Start from the empty project that has been prepared for you (training repo, recommended): https://github.com/corda/corda-training-code/tree/master/010-empty-project
* Start from Corda's Java template (Corda repo) https://ide.corda.net/?folder=%2Fhome%2Fcoder%2Fcordapp-template-java
* Start from the `cordapp-example` (Prepare and Discover module): https://ide.corda.net/?folder=%2Fhome%2Fcoder%2Fsamples-java%2FBasic%2Fcordapp-example
* Use the online IDE to fiddle with the empty project: https://ctdwgf.ide.corda.net/?folder=/home/coder/corda-training-code/010-empty-project
