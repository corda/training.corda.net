...
If you are new to blockchains and distributed ledgers, start with the [Fundamentals](./fundamentals/introduction/) module. This brief overview of the universe of distributed application platforms provides background information that will help you appreciate Corda's unique approach. Then, carry on to [Key Concepts](./key-concepts/introduction/) to discover Corda's unique approach to distributed applications for enterprise settings.
