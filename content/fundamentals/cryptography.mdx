...
* First you have to choose two prime numbers $p$ and $q$. Then, you can calculate $n(p,q)=p \cdot q$.
* After that, you calculate Euler's totient function
...
Where you can use the extended euclidean algorithm. Now you can delete $p,q$ and $\phi(n)$.

### Example

Let's have a look on an example.

* You use $p=2399$ and $q=26371$, which are prime numbers.
Then you have $n=63264029$ and $\phi(n)= 63235260$.
* Now, you have to set a $pubKey< \phi(n)$. So you use $pubKey=54833$.
* That gives you, with extended euclid, a $priKey=6589577$

Now you delete $p,q$ and $\phi(n)$. If you want to encrypt the $message=9874587$m you get:
...
That means you can prove, if $x \cdot y$ calculated well, without knowing x or y.

In our example, if you use $x=12$ and $y=24$, then you get $12 \cdot 24=288$  for the output and you get $$E(12) \cdot E(24) \equiv E(288) \equiv 60822364  \mod 63264029 $$ with same $(pubKey,n)$ and $priKey$ like in the above section. So if you give someone $E(12)$, $E(24)$ and our output $288$, they can verify, if the calculation is done well, without knowing $x$ and $y$.
