...
description: How would you create a flow to sell a car?
...
Observe an untested example flow [here](https://git.b9lab.com/client-projects/r3-corda-education-services/r3-course-project/blob/030-tokens-sdk/030-tokens-sdk/workflows/src/test/java/com/template/car/flow/bad/NonAtomicSale.java).
...
Hello? IAEA? That must be a wrong number.
