...
This module introduces you to the concepts behind the Corda platform in detail. Now that you have studied the history and [fundamentals](/fundamentals/introduction/) of blockchain technologies you will discover how the Corda platform is similar to and differentiated from other blockchain platforms.
...
The transaction is finalised when the conditions are met and the required signatures are collected. Finalisation consumes old states and produces new states. As you will see in more detail later in the course, a _Notary_ ensures that states can only be consumed once, and this prevents double-spending.
