...
Congratulations! You have come a long way. Starting with an introduction to distributed ledger technology (DLT), you have created your first CorDapp and added sophistication through a series of improvements. Your CorDapp encapsulates working examples of the techniques you will use to create enterprise applications with Corda. You may continue adding to it, [a GUI](https://github.com/corda/samples-java/tree/master/Basic/spring-webserver) for instance. Or try third-party tools, like [Ganache for Corda](https://www.trufflesuite.com/blog/unwrap-the-corda-flavored-ganache-beta).
