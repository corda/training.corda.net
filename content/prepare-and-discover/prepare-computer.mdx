...
description: And Java preparation
...
Find a thorough guide [here](https://docs.corda.net/getting-set-up.html). The following is the minimal setup to get started:

- **Oracle JDK:** This is important. Be sure to install the [Oracle JDK version 8](https://www.oracle.com/java/technologies/javase/javase-jdk8-downloads.html) (not the JRE) at version 8u171 or higher. If you have a newer version of Java installed, you need to install version 8 alongside it. Below, and later in the course, we show how you can point Corda to the desired version.
- **IDE:** You may use any Java-able IDE you like. [IntelliJ IDEA Community Edition](https://www.jetbrains.com/idea/download/#section=mac) is our first choice and it will be used throughout this training. We will introduce VisualStudioCode in a following section.
...
- **Gradle:** Corda uses the Gradle build system. However, you do not need to install anything. We will use the IDE's project commands which will download it as necessary.
...
```
In case this is relevant, now or in the future, let us collect the different ways available to overcome such hurdles.
...
- [samples](https://github.com/corda/samples-java): if you are looking for a code example, or a way to do something, an example can probably be found there.
...
The Corda team merges ongoing work into snapshots that may be unstable. Generally, unless you have a very good reason for needing to use a snapshot version or a release candidate, the more cautious approach is run with major releases which you can find [here](https://github.com/corda/corda/releases).
